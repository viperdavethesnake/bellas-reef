...
| **E2** | **Ruled by David, 2026-08-18 12:45: dozens at most.** The on-board RP1 PWM (4 channels) plus one PCA9685 board (16 channels), plus probes — "that's our boundary for now". Not hundreds; not a second board yet. | Unblocks Tier C. Sizes it too: Hardware is bounded at ~20 PWM channels across two sources; C1's index and C2's board → channel grouping are designed for that, not for a rack. |
